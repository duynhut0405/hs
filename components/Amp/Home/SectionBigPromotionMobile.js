            ...
            <div className={`col  efch-${index} ef-img-t`} key={index}>
              ...
              <a href={`/blog/post/${item.identifier}`} className="item box-shadow">
                <div className="img tRes_66">
                  <img className="lazy-hidden" data-lazy-type="image" data-lazy-src={item.featured_img == undefined ? process.env.EMPTY_IMG : process.env.DOMAIN_IMAGE + item.featured_img} src="/images/no-image.svg" alt={item.title} />
