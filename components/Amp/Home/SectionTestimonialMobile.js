              ...
              <div className="item box-shadow">
                ...
                <div className="user">
                  <div className="avatar tRes">
                    <img className="lazy-hidden" data-lazy-type="image" data-lazy-src={item.image == undefined ? process.env.EMPTY_IMG : process.env.DOMAIN_IMAGE + 'testimonial/images/' + item.image} src="/images/no-image.svg" alt={item.title} />
                  </div>
                  <div className="ratingresult">
                    <ShowStarTestimonial rating={item.rating != null ? item.rating : 0} />
                    <strong className="cl1">{item.rating != null ? item.rating : '0'}/5</strong>
                  </div>
