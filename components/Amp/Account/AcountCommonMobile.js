            ...
            <div className="item">
              ...
              <div className="mb-20">
                {(user.lastname != undefined && user.firstname != undefined) && (
                  ...
                  <div className="name">{t('fullname')}: {user.firstname} </div>
                )}
                {(check != undefined) && (
              ...
              <div className="wbtn">
                <Link href="/account/edit">
                  <a href="/account/edit" className="btn btn-4">{t('fix')}</a>
                </Link>
              </div>
            </div>
            <div className="item">
              ...
              {(defaultBillingAddress != undefined && defaultBillingAddress) && (
                <div className="mb-20">
                  ...
                  <div className="name">{defaultBillingAddress.firstname} </div>
              ...
              <div className="wbtn">
                <Link href="/account/address/billing-default">
                  <a href="/account/address/billing-default" className="btn btn-4">{(defaultBillingAddress != undefined && defaultBillingAddress) ? t('fix') : t('adding')}</a>
                </Link>
              </div>
            </div>
            <div className="item">
              ...
              {(defaultShippingAddress != undefined && defaultShippingAddress) && (
                <div className="mb-20">
                  ...
                  <div className="name">{defaultShippingAddress.firstname} </div>
              ...
              <Link href="/account/address/shipping-default">
                <a href="/account/address/shipping-default" className="btn btn-4">{(defaultBillingAddress != undefined && defaultBillingAddress) ? t('fix') : t('adding')}</a>
              </Link>
            </div>
              ...
              {orderedProducts && orderedProducts.length != 0 && (
                orderedProducts.map((item, index) => (
                  <div className="item " key={index}>
                    <a href={item.extension_attributes.url_key ? `/product/${item.extension_attributes.url_key}` : "#"} className="img tRes_68">
                      <img className="lazy-hidden" src={item.extension_attributes.thumbnail ? item.extension_attributes.thumbnail : "/images/hoasen-product.jpg"} alt={item.name || ''} />
                    </a>
                    <div className="divtext">
                      ...
                      <div className="action">
                        ...
                        <Link href={`/product/${item.extension_attributes.url_key}`}>
