...
const propTypes = {
  menuUser1: PropTypes.array,
  menuUser2: PropTypes.array
};

function MenuUser({ menuUser1, menuUser2 }) {
          ...
          <div className="uname" onClick={() => setShowDetails(true)}>
              ...
              <div className="text">
                  {(user.lastname != undefined && user.firstname != undefined) && (
                    <div className="t1">{user.firstname} {user.lastname}</div>
                  )}
