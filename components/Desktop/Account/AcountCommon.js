          ...
          <div className="box-shadow box-info">
            ...
            <div className="item">
              ...
              {(defaultShippingAddress != undefined && defaultShippingAddress) && (
                <div className="mb-20">
                  <div className="name">{defaultShippingAddress.lastname} {defaultShippingAddress.firstname}</div>
                ...
                orderedProducts.map((item, index) => (
                  <div className="item " key={index}>
                    ...
                    <div className="divtext">
                      <div className="line-3 title"><a href={item.extension_attributes.url_key ? `/product/${getLastSlashProduct(item.extension_attributes.url_key)}` : "#"}>{item.name ? item.name : 'product'}</a></div>
