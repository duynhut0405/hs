        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <label className="full mb-20">
            ...
            <div>
              ...
              />
              <i style={{position: "absolute", right: "7%", marginTop: "10px"}} className={togglePasswordShow ? "icon-view" : "icon-view"} onClick={ () => setTogglePasswordShow(togglePasswordShow ? false : true)}></i>
            </div>
          ...
          <label className="full mb-20">
            ...
            <div>
              ...
              />
              <i style={{position: "absolute", right: "7%", marginTop: "10px"}} className={togglePasswordRepeatShow ? "icon-view" : "icon-view"} onClick={ () => setTogglePasswordRepeatShow(togglePasswordRepeatShow ? false : true)}></i>
            </div>
