  ...
  const submit = async (item) => {
    ...
    let data = {
      ...
      custom_attributes: {
        ...
        district: currentDistrict.full_name,
        district_id: currentDistrict.value,
        ward: currentWard.full_name,
      ...
      <>
        ...
        {state != null &&
          <form className={updating ? "page-user-info loading" : "page-user-info"} onSubmit={handleSubmit(submit)}>
            <div className="pd-15 sec-bd-bottom">
              <div className="mb-20">
                ...
                <input className="input"
                  defaultValue={`${user?.firstname} ${user?.lastname}`} placeholder="Họ và tên" name="fullname"
              ...
              <div className="mb-20">
                <div className="input-title"><span className="require">*</span> {t('phone')}</div>
                <input className="input style-2" value={user?.telephone} placeholder="Số Điện thoại" name="telephone" onChange={(e) => { updateState(e) }} ref={register({
                    required: {
                      value: true,
              ...
              <div className="mb-20">
                <div className="input-title"><span className="require">*</span> {t('street')}</div>
                <input className="input style-2" value={state.street[0]} placeholder="Địa chỉ" name="street" onChange={(e) => { updateStreet(e) }} ref={register({
                    required: {
                      value: true,
              ...
              {cities && (
                <div className="mb-20">
                  <div className="input-title"><span className="require">*</span> {t('choise_city')}</div>
              ...
              {districts && (
                <div className="mb-20">
                  <div className="input-title"><span className="require">*</span>{t('choise_district')}</div>
              ...
              {wards && (
                <div className="mb-20">
                  <div className="input-title"><span className="require">*</span>{t('choise_ward')}</div>
            ...
            <button className="btn btn-4" type="submit">{isAdding ? t('adding') : t('save_changed_info')}</button>
          </form>}
      </>
      :
      <Layout>
        <BreadCrumb data={[{ name: t('account_info'), link: '/account', isActive: false }, { name: t('default_user_shipping_address'), link: '/account/address/shipping-default', isActive: true }]} />
        <main className="sec-tb page-user-info">
          <div className="container">
            <div className="row">
              ...
              {state != null ? (<div className="col-12 col-md-9">
