...
function Paint({}) {
  ...
  const currentPirture = '/tool-bedroom/phong-ngu-03.jpg';
  ...
  return (
    <Layout>
      <BreadCrumb data={[{name: 'Phòng ngủ hiện đại', link: '/account', isActive: true}]}/>
          ...
          <div className="row end">
            <div className="col-lg-10 col-md-9">
              <div className="box-shadow mb-20">
                <h3 className="box-title-3">Phòng ngủ hiện đại</h3>
